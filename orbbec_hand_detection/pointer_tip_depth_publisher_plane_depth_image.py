...
class PointerTipDepthPlanePublisher(Node):
    def __init__(self, loop):
        super().__init__('pointer_tip_depth_plane_depth_image')
        ...
        self.declare_parameter('depth_threshold_lower', 0.5) # meters
        self.declare_parameter('depth_threshold_upper', 0.5) # meters
    ...
    def image_callback(self, rgb_msg, depth_msg):
        ...
        if self.use_grayscale:
            rgb_image_for_mediapipe = depth_image
            ...
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if self.x1 <= index_tip_x <= self.x2 and self.y1 <= index_tip_y <= self.y4:
                    ...
                    if is_touch :
                        ...
                        cv2.putText(rgb_image, 'TOUCH', (0, 0), font, 4, (0, 255, 0), 4)
                        ...
                        scaled_x, scaled_y = self.map_point_to_screen_resolution(point, self.surface_width, self.surface_height, screen_width_offsetted, screen_height_offsetted)
